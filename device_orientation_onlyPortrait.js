...
if ( Modernizr.touch ) {
    detectOrientation(); 
    window.addEventListener("orientationchange", detectOrientation_delay, false);
    // ou
    //$(window).on('orientationchange',detectOrientation_delay);
}
...
function detectOrientation_delay () {
...
//http://solvedstack.com/questions/android-viewport-setting-user-scalable-no-breaks-width-zoom-level-of-viewport
